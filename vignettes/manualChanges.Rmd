...
cat("3")
<<<<<<< HEAD
sigma1 = eigen(hessian)
return(sigma1)
sigma1 = solve(hessian)
=======
theEigen = eigen(hessian)
sigma1 = (theEigen$vectors) %*% diag(1/theEigen$values) %*% solve(theEigen$vectors)  
>>>>>>> cd1d3a58bd0a177073a7701246f5307b55401d95
cat("4")
...
theSnFit = sn::msn.mle(
  ...
  trace = TRUE,
  control=list(maxit=1e6,  trace=FALSE, reltol = 1e-9, 
